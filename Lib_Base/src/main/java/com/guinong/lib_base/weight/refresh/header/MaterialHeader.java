...
import com.guinong.lib_base.weight.refresh.material.CircleImageView;
import com.guinong.lib_base.weight.refresh.material.MaterialProgressDrawable;
import com.guinong.lib_base.weight.refresh.material.SmartUtil;
...
public class MaterialHeader extends InternalAbstract implements RefreshHeader {
    ...
    public MaterialHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mProgress.setColorSchemeColors(0xff000000,0xff000000,0xff000000,0xff000000,0xff000000);
